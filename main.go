...
func (pbs *pbstate) handleMessageBody(msg *proto.Message) {
	...
	for _, element := range msg.Elements {
		...
		case *proto.NormalField:
			...
			// with Comments - VERY-UGLY-WARNING! - enable this:
			// if actual.Field.Comment != nil {
			// 	t.addRow("", typenameComment, strings.Join(strings.Split(actual.Field.Comment.Message(), "."), "<br/>"), strconv.Itoa(actual.Sequence), Comment, "")
			// }
